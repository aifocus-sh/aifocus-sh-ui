...
import { TweetsSchema } from "./schema";
  ...
  return (
    <main className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
      ...
      <div className="md:overflow-auto md:pr-4 md:h-[calc(100vh-120px)]">
        ...
        {object?.tweets?.slice(0, 1).map((tweet, index) => (
          <div
          ...
          >
            <div className="flex justify-between items-center mb-4">
              <div className="w-full text-white flex gap-4 items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">@aihub_sh</p>
                </div>
              </div>
              <div
            ...
            <p className="break-words mt-2">{tweet?.text}</p>
            <div className="h-[30px]" />
          </div>
        ))}

        {object?.tweets?.slice(1).map((tweet, index) => (
